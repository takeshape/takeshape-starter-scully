...
4. In the terminal on your local machine, clone this repo with `git clone https://github.com/takeshape/takeshape-starter-scully`
...
Alternatively, run the `npm run scully-all` custom command we've configured in the package.json.


## Learn More

Check out [our docs on this project](https://app.takeshape.io/docs/get-started/ssg/scully/) to learn how this example works.